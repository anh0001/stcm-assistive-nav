...
class SegmentAnythingPredictor(ObjectPredictor):
    ...
    def __init__(self, checkpoint_path: str | None = None):
        ...
        self.sam = sam_model_registry["vit_t"](checkpoint=str(resolved_ckpt))
    ...
    def _resolve_checkpoint_path(self, checkpoint_path):
        ...
        candidates.extend(
            [
                ...
                Path("ckpts") / "mobilesam" / "mobile_sam.pt",
                DEFAULT_CKPT_DIR / "mobilesam" / "vit_t.pth",
                DEFAULT_CKPT_DIR / "mobilesam" / "mobile_sam.pt",
            ]
        )
        for path in candidates:
    ...
    def predict(self, image, prompt_bboxes):
        ...
        try:
            ...
            if prompt_bboxes is not None:
                # Validate bounding boxes before processing
